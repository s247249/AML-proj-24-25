...
def fine_tune_clip_model(args):
    ...
    # Change the name of the dataset you want the model to train on
    dataset_name = "DTD"  
    ...
    finetuned_save_path = f"{args.save}/{dataset_name}_fine_tuned.pt"
...
python finetune.py --data-location /content/dataset/ --save /content/checkpoint